...
## Описание проекта.
Трекер полезных привычек. Реализована бэкенд-часть SPA веб-приложения с рассылкой напоминаний в телеграм.
...
3. приложения: habittracker, users
...
3. Покрытие тестами составляет 87 %
